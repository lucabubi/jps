...
@WebMvcTest
class CRMControllerTests(@Autowired val mockMvc: MockMvc, @Autowired val objectMapper: ObjectMapper) {
    ...
    fun whenCreateCustomer_thenReturnCreatedCustomerDTO() {
        ...
        every { crmService.createCustomer(customerDTO) } returns customerDTO
        ...
        verify { crmService.createCustomer(customerDTO) }
    }
    ...
    fun whenCreateProfessional_thenReturnCreatedProfessionalDTO() {
        ...
        every { crmService.createProfessional(professionalDTO) } returns professionalDTO
        ...
        verify { crmService.createProfessional(professionalDTO) }
    }
    ...
    fun whenGetCustomers_thenReturnCustomerDTOList() {
        ...
        every { crmService.getCustomers() } returns customers
        ...
        verify { crmService.getCustomers() }
    }
    ...
    fun whenGetCustomer_thenReturnCustomerDTO() {
        ...
        every { crmService.getCustomer(id) } returns customerDTO
        ...
        verify { crmService.getCustomer(id) }
    }
    ...
    fun whenGetCustomer_thenThrowCustomerNotFoundException() {
        // Arrange
        val id = 1L
        every { crmService.getCustomer(id) } throws CustomerNotFoundException("Customer with id: $id not found")
    ...
    fun whenGetProfessional_thenReturnProfessionalDTO() {
        ...
        every { crmService.getProfessional(id) } returns professionalDTO
        ...
        verify { crmService.getProfessional(id) }
    }
    ...
    fun whenGetProfessional_thenThrowProfessionalNotFoundException() {
        // Arrange
        val id = 1L
        every { crmService.getProfessional(id) } throws ProfessionalNotFoundException("Professional with id: $id not found")
    ...
    fun testGetJobOffers(){
        ...
        every { crmService.getJobOffers(any(), any(), any(), any()) } returns jobOffersDTOlist
    ...
    fun testGetOpenJobOffers_statusOk(){
        ...
        every { crmService.getOpenJobOffers(customer.id, pageable) } returns jobOffersSet.map { it.toDTO() }
    ...
    fun testGetOpenJobOffers_statusNotFound(){
        ...
        every { crmService.getOpenJobOffers(customerId, pageable) } throws CustomerNotFoundException("Customer with id: $customerId not found")
    ...
    fun testGetAcceptedJobOffers_statusOk(){
        ...
        every { crmService.getAcceptedJobOffers(professional.id, pageable) } returns jobOffersSet.map { it.toDTO() }
    ...
    fun testGetAcceptedJobOffers_statusNotFound(){
        ...
        every { crmService.getAcceptedJobOffers(professionalId, pageable) } throws ProfessionalNotFoundException("Professional with id: $professionalId not found")
    ...
    fun getAbortedJobOffers_statusOk(){
        ...
        every { crmService.getAbortedJobOffers(pageable, null, null) } returns jobOffers
    ...
    fun getAbortedJobOffersFilteredByCustomer_statusOk(){
        ...
        every { crmService.getAbortedJobOffers(pageable, customer.id, null) } returns jobOffers.filter { it.customer.id == customer.id }
    ...
    fun testGetAbortedJobOffersFilteredByCustomer_statusNotFound(){
        ...
        every { crmService.getAbortedJobOffers(pageable, customerId, null) } throws CustomerNotFoundException("Customer with id: $customerId not found")
    ...
    fun testGetAbortedJobOffersFilteredByProfessional_statusOk(){
        ...
        every { crmService.getAbortedJobOffers(pageable, null, professional.id) } returns jobOffers.filter { it.professional?.id == professional.id }
    ...
    fun testGetAbortedJobOffersFilteredByProfessional_statusNotFound(){
        ...
        every { crmService.getAbortedJobOffers(pageable, null, professionalId) } throws ProfessionalNotFoundException("Professional with id: $professionalId not found")
    ...
    fun testGetAbortedJobOffersFilteredByCustomerProfessional_statusOk(){
        ...
        every { crmService.getAbortedJobOffers(pageable, customer.id, professional.id) } returns jobOffers.filter { it.professional?.id == professional.id && it.customer.id == customer.id }
    ...
    fun testChangeJobOfferStatus() {
        ...
        every { crmService.updateJobOffer(any(), any()) } returns JobOfferDTO(
            1L,
            "First job offer",
    ...
    fun testGetJobOfferValue(){
        ...
        every { crmService.getJobOfferValue(any()) } returns jobOfferValue
