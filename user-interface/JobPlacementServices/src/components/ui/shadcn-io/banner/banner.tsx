...
export const Banner = ({
    ...
    return (
        <BannerContext.Provider value={{ show, setShow }}>
            <div
                className={cn(
                    'flex w-full items-center justify-between text-center gap-2 bg-primary px-3 py-0 text-primary-foreground',
                    className
                )}
                {...props}
            >
...
export const BannerTitle = ({ className, ...props }: BannerTitleProps) => (
    <p className={cn('flex-1 text-xs sm:text-sm md:text-base font-semibold', className)} {...props} />
);
...
export const BannerClose = ({
    ...
    return (
        <Button
            className={cn(
                'shrink-0 text-white hover:text-white focus:text-white active:text-white bg-transparent hover:bg-transparent focus:bg-transparent active:bg-transparent',
                className
            )}
            onClick={handleClick}
            size={size}
